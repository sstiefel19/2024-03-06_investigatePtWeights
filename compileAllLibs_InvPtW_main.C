...
void compileAllLibs()
{
    // utils_sstiefel_2024 has to be compiles before all others
    bool u0 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/utils_sstiefel_2024.cpp+");
    bool u1 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/GCo.cpp+");
    bool u2 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/utils_fits.cpp+");
