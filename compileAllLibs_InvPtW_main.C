...
void compileAllLibs_InvPtW_main()
{
    ...
    bool u5 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/utils_plotting.cpp+");
    bool u6 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/utils_fits.cpp+");
    bool u7 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/utils_TF1.cpp+");
    bool u8 = gROOT->ProcessLine(".L /analysisSoftware/utils_sstiefel_2024/src/utils_TH1.cpp+");
